...
function sleep(ms) {
  ...
  await synthetics.executeStep('Click_1', async function() {
    ...
    await page.click('form #username')
  })
  
  await synthetics.executeStep('Type_2', async function() {
    await page.type('form #username', "renskelotte48")
  })
  ...
  await synthetics.executeStep('Click_4', async function() {
    await page.waitForSelector('.MuiDataGrid-virtualScrollerRenderZone > .MuiDataGrid-row > .MuiDataGrid-cell--withRenderer > .MuiButtonBase-root > .MuiSvgIcon-root')
    await page.click('.MuiDataGrid-virtualScrollerRenderZone > .MuiDataGrid-row > .MuiDataGrid-cell--withRenderer > .MuiButtonBase-root > .MuiSvgIcon-root')
  })
