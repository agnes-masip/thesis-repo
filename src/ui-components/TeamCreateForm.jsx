...
export default function TeamCreateForm(props) {
  ...
  const [teamOwner, setTeamOwner] = React.useState(initialValues.teamOwner);
  const [members, setMembers] = React.useState(initialValues.members);
  const [errors, setErrors] = React.useState({});
  const resetStateValues = () => {
    setName(initialValues.name);
    setTeamOwner(initialValues.teamOwner);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.teamOwner ?? value;
          }
          if (errors.teamOwner?.hasError) {
            runValidationTasks("teamOwner", value);
          }
          setTeamOwner(value);
        }}
        onBlur={() => runValidationTasks("teamOwner", teamOwner)}
        errorMessage={errors.teamOwner?.errorMessage}
        hasError={errors.teamOwner?.hasError}
        {...getOverrideProps(overrides, "teamOwner")}
      ></TextField>
      <ArrayField
