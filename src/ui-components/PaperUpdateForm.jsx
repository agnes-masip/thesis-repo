...
export default function PaperUpdateForm(props) {
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Paper, idProp) : paper;
      setPaperRecord(record);
    };
    queryData();
  }, [idProp, paper]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Paper.copyOf(paperRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PaperUpdateForm")}
      {...rest}
    >
      <TextField
        label="Title"
